...
def export_result(cuenca, path_result):
    ...
    # cuencaExportar.to_excel(rutaGuardar + '/' + f'cuencaDk_{Name_Basin}.xlsx', index=None)
    ...
    for nombreRaster in cuencaExportar.columns.values.tolist():
        ...
        raster.exportRaster(path_result + '/result/' + f'{nombreRaster}.tif')