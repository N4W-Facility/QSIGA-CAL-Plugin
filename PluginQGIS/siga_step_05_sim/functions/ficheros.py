...
def create_outputs_folders(path_out, name_project, scenario=None):
    ...
    inside_folders = ['calibracion', 'ciclos', 'ejecucion', 'mapas', 'movmasa', 'muestras', 'series', 'topologia',
                      'vertimientos']
    ...
    for main_folder in main_folders:
        ...
        elif main_folder == 'salidas':
            scenario_folder = 'BaseLine' if scenario is None else scenario
            inside_folder_path = os.path.join(main_folder_path, scenario_folder)
            os.makedirs(inside_folder_path, exist_ok=True)
...
class Ficheros(dict):
    ...
    def crear_archivo_condiciones_frontera(self,dic_df):
        ...
        if os.path.exists(self.ruta_cuenca_SIGA + 'condicionesfrontera/'):
            pass
        else:
            os.makedirs(self.ruta_cuenca_SIGA + 'condicionesfrontera/')

        escribe_archivo(self.ruta_cuenca_SIGA + 'condicionesfrontera/'+ self.archivo_condiciones_frontera,encabezados,dic_vertimientos)

        print('Aviso de crear_archivo_vertimientos: El archivo '+self.archivo_condiciones_frontera+' se creó correctamente')
    ...
    def crear_archivo_ejecucion(self):
        ...
        if os.path.exists(self.ruta_cuenca_SIGA + 'ejecucion'+ os.path.sep):
            pass
        else:
            os.makedirs(self.ruta_cuenca_SIGA + 'ejecucion'+ os.path.sep)


        escribe_archivo(self.ruta_cuenca_SIGA + 'ejecucion' + os.path.sep + self.archivo_ejecucion,encabezados,d1)
