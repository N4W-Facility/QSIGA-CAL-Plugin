...
def Modify_csvHyParms(ProjectPath, JSONPath, NameSIGAFolder, Params, TypeModel='Hy',Posi=[]):
    ...
    # Obtener la ruta del directorio actual (subplugin3)
    current_dir = os.path.dirname(__file__)

    # Subir al directorio principal del plugin
    parent_dir = os.path.abspath(os.path.join(current_dir, os.pardir, os.pardir))

    # Definir la ruta hacia 'archivos_csv' dentro de 'subplugin1'
...
def Create_CalibrationFile(ProjectPath, JSONPath, NameSIGAFolder, NameCalibration):
    ...
    # Ruta completa hacia la carpeta 'calibracion' dentro de 'subplugin1'
